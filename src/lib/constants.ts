...
export const currencyCountries = [
  ...
  },
  {
    ...
    symbol: "$",
    rate: 1,
    countries: [{ value: "USA", label: "United States", distanceFactor: 0 }],
  },
  {
    code: "AUD",
    ...
    symbol: "A$",
    rate: 1.51,
    countries: [{ value: "AUS", label: "Australia", distanceFactor: 0.6 }],
  },
  {
    code: "EUR",
    name: "Euro",
  ...
  },
  {
    ...
    symbol: "£",
    rate: 0.78,
    countries: [{ value: "GBR", label: "United Kingdom", distanceFactor: 0.3 }],
  },
  {
    code: "JPY",
    name: "Japanese Yen",
  ...
  },
  {
    ...
    symbol: "NZ$",
    rate: 1.63,
    countries: [{ value: "NZL", label: "New Zealand", distanceFactor: 0.6 }],
  },
  {
    code: "CHF",
    name: "Swiss Franc",
    symbol: "CHF",
    rate: 0.88,
    countries: [{ value: "CHE", label: "Switzerland", distanceFactor: 0.3 }],
  },
  {
    code: "SEK",
    name: "Swedish Krona",
  ...
  },
  {
    ...
    symbol: "kr",
    rate: 6.87,
    countries: [{ value: "DNK", label: "Denmark", distanceFactor: 0.4 }],
  },
  {
    code: "RUB",
    name: "Russian Ruble",
    symbol: "₽",
    rate: 90.86,
    countries: [{ value: "RUS", label: "Russia", distanceFactor: 0.6 }],
  },
  {
    code: "AED",
