...
export const currencyCountries = [
  // United States Dollar (USD)
  {
    ...
    countries: [
      ...
      { value: "ASM", label: "American Samoa", distanceFactor: 0.2 },
      { value: "GUM", label: "Guam", distanceFactor: 0.4 },
      { value: "MNP", label: "Northern Mariana Islands", distanceFactor: 0.4 },
      { value: "PRI", label: "Puerto Rico", distanceFactor: 0.2 },
      { value: "VIR", label: "U.S. Virgin Islands", distanceFactor: 0.2 },
      {
        value: "BES",
      ...
      { value: "PLW", label: "Palau", distanceFactor: 0.35 },
      { value: "MHL", label: "Marshall Islands", distanceFactor: 0.35 },
      {
        value: "FSM",
        label: "Federated States of Micronesia",
        distanceFactor: 0.35,
      },
      { value: "VGB", label: "British Virgin Islands", distanceFactor: 0.8 },
      { value: "TCA", label: "Turks and Caicos Islands", distanceFactor: 0.8 },
      { value: "TLS", label: "Timor-Leste", distanceFactor: 0.1 },
      { value: "ZWE", label: "Zimbabwe", distanceFactor: 0.13 },
    ],
  },
  // Canadian Dollar (CAD)
  {
    ...
    symbol: "CA$",
    rate: 1.35,
    countries: [{ value: "CAN", label: "Canada", distanceFactor: 0.2 }],
  },
  // Australian Dollar (AUD)
  {
    ...
    rate: 1.51,
    countries: [
      { value: "AUS", label: "Australia", distanceFactor: 0.14 },
      { value: "CXR", label: "Christmas Island", distanceFactor: 0.14 },
      { value: "CCK", label: "Cocos (Keeling) Islands", distanceFactor: 0.14 },
      { value: "NRU", label: "Nauru", distanceFactor: 0.16 },
      { value: "NFK", label: "Norfolk Island", distanceFactor: 0.14 },
      {
        value: "HMD",
  ...
  // Euro (EUR)
  {
    ...
    rate: 0.92,
    countries: [
      { value: "FRA", label: "France", distanceFactor: 0.7 },
      { value: "DEU", label: "Germany", distanceFactor: 0.7 },
      { value: "ITA", label: "Italy", distanceFactor: 0.8 },
      { value: "ESP", label: "Spain", distanceFactor: 0.8 },
      { value: "NLD", label: "Netherlands", distanceFactor: 0.7 },
      { value: "GRC", label: "Greece", distanceFactor: 0.9 },
      { value: "AUT", label: "Austria", distanceFactor: 0.7 },
      { value: "BEL", label: "Belgium", distanceFactor: 0.7 },
      { value: "HRV", label: "Croatia", distanceFactor: 0.8 },
      { value: "CYP", label: "Cyprus", distanceFactor: 0.1 },
      { value: "EST", label: "Estonia", distanceFactor: 0.9 },
      { value: "FIN", label: "Finland", distanceFactor: 0.8 },
      { value: "IRL", label: "Ireland", distanceFactor: 0.7 },
      { value: "LVA", label: "Latvia", distanceFactor: 0.9 },
      { value: "LTU", label: "Lithuania", distanceFactor: 0.9 },
      { value: "LUX", label: "Luxembourg", distanceFactor: 0.7 },
      { value: "MLT", label: "Malta", distanceFactor: 0.9 },
      { value: "PRT", label: "Portugal", distanceFactor: 0.8 },
      { value: "SVK", label: "Slovakia", distanceFactor: 0.8 },
      { value: "SVN", label: "Slovenia", distanceFactor: 0.8 },
      { value: "AND", label: "Andorra", distanceFactor: 0.8 },
      { value: "MCO", label: "Monaco", distanceFactor: 0.8 },
      { value: "SMR", label: "San Marino", distanceFactor: 0.8 },
      { value: "VAT", label: "Vatican City", distanceFactor: 0.8 },
    ],
  },
  // British Pound Sterling (GBP)
  {
    ...
    rate: 0.78,
    countries: [
      { value: "GBR", label: "United Kingdom", distanceFactor: 0.6 },
      {
        value: "BAT",
      ...
      { value: "FLK", label: "Falkland Islands", distanceFactor: 0.16 },
      { value: "GIB", label: "Gibraltar", distanceFactor: 0.6 },
      { value: "GGY", label: "Guernsey", distanceFactor: 0.6 },
      { value: "IMN", label: "Isle of Man", distanceFactor: 0.6 },
      { value: "JEY", label: "Jersey", distanceFactor: 0.6 },
      {
        value: "SHH",
  ...
  // Japanese Yen (JPY)
  {
    ...
    symbol: "¥",
    rate: 149.82,
    countries: [{ value: "JPN", label: "Japan", distanceFactor: 0.11 }],
  },
  // Chinese Yuan (CNY)
  {
    code: "CNY",
    ...
    symbol: "¥",
    rate: 7.23,
    countries: [{ value: "CHN", label: "China", distanceFactor: 0.8 }],
  },
  // Indian Rupee (INR)
  {
    code: "INR",
    ...
    symbol: "₹",
    rate: 83.14,
    countries: [{ value: "IND", label: "India", distanceFactor: 0.12 }],
  },
  // Brazilian Real (BRL)
  {
    code: "BRL",
    ...
    symbol: "R$",
    rate: 5.14,
    countries: [{ value: "BRA", label: "Brazil", distanceFactor: 0.9 }],
  },
  // South African Rand (ZAR)
  {
    ...
    symbol: "R",
    rate: 18.33,
    countries: [{ value: "ZAF", label: "South Africa", distanceFactor: 0.12 }],
  },
  // Mexican Peso (MXN)
  {
    code: "MXN",
    ...
    symbol: "MX$",
    rate: 16.87,
    countries: [{ value: "MEX", label: "Mexico", distanceFactor: 0.2 }],
  },
  // South Korean Won (KRW)
  {
    ...
    symbol: "₩",
    rate: 1335.97,
    countries: [{ value: "KOR", label: "South Korea", distanceFactor: 0.1 }],
  },
  // Singapore Dollar (SGD)
  {
    ...
    symbol: "S$",
    rate: 1.34,
    countries: [{ value: "SGP", label: "Singapore", distanceFactor: 0.13 }],
  },
  // New Zealand Dollar (NZD)
  {
    ...
    rate: 1.63,
    countries: [
      { value: "NZL", label: "New Zealand", distanceFactor: 0.14 },
      { value: "COK", label: "Cook Islands", distanceFactor: 0.14 },
      { value: "NIU", label: "Niue", distanceFactor: 0.14 },
      { value: "TKL", label: "Tokelau", distanceFactor: 0.14 },
    ],
  },
  // Swiss Franc (CHF)
  {
    ...
    rate: 0.88,
    countries: [
      { value: "CHE", label: "Switzerland", distanceFactor: 0.7 },
      { value: "LIE", label: "Liechtenstein", distanceFactor: 0.7 },
    ],
  },
  // Swedish Krona (SEK)
  {
    ...
    symbol: "kr",
    rate: 10.45,
    countries: [{ value: "SWE", label: "Sweden", distanceFactor: 0.8 }],
  },
  // Norwegian Krone (NOK)
  {
    code: "NOK",
    ...
    symbol: "kr",
    rate: 10.59,
    countries: [{ value: "NOR", label: "Norway", distanceFactor: 0.9 }],
  },
  // Danish Krone (DKK)
  {
    code: "DKK",
    ...
    rate: 6.87,
    countries: [
      { value: "DNK", label: "Denmark", distanceFactor: 0.9 },
      { value: "FRO", label: "Faroe Islands", distanceFactor: 0.9 },
      { value: "GRL", label: "Greenland", distanceFactor: 0.9 },
    ],
  },
  // Russian Ruble (RUB)
  {
    ...
    rate: 90.86,
    countries: [
      { value: "RUS", label: "Russia", distanceFactor: 0.11 },
      { value: "ABK", label: "Abkhazia", distanceFactor: 0.11 },
      { value: "SOS", label: "South Ossetia", distanceFactor: 0.11 },
    ],
  },
  // United Arab Emirates Dirham (AED)
  {
    ...
    rate: 3.67,
    countries: [
      { value: "ARE", label: "United Arab Emirates", distanceFactor: 0.15 },
    ],
  },
  // Chilean Peso (CLP)
  {
  ...
  // Czech Koruna (CZK)
  {
    ...
    symbol: "Kč",
    rate: 22,
    countries: [{ value: "CZE", label: "Czech Republic", distanceFactor: 0.9 }],
  },
  // Hong Kong Dollar (HKD)
  {
    ...
    symbol: "HK$",
    rate: 7.8,
    countries: [{ value: "HKG", label: "Hong Kong", distanceFactor: 0.12 }],
  },
  // Hungarian Forint (HUF)
  {
    ...
    symbol: "Ft",
    rate: 370,
    countries: [{ value: "HUN", label: "Hungary", distanceFactor: 0.11 }],
  },
  // Indonesian Rupiah (IDR)
  {
    ...
    symbol: "Rp",
    rate: 15000,
    countries: [{ value: "IDN", label: "Indonesia", distanceFactor: 0.15 }],
  },
  // Israeli New Shekel (ILS)
  {
    ...
    symbol: "₪",
    rate: 3.5,
    countries: [{ value: "ISR", label: "Israel", distanceFactor: 0.13 }],
  },
  // Malaysian Ringgit (MYR)
  {
    ...
    symbol: "RM",
    rate: 4.5,
    countries: [{ value: "MYS", label: "Malaysia", distanceFactor: 0.16 }],
  },
  // Pakistani Rupee (PKR)
  {
    code: "PKR",
    ...
    symbol: "₨",
    rate: 280,
    countries: [{ value: "PAK", label: "Pakistan", distanceFactor: 0.13 }],
  },
  // Philippine Peso (PHP)
  {
    code: "PHP",
    ...
    symbol: "₱",
    rate: 50,
    countries: [{ value: "PHL", label: "Philippines", distanceFactor: 0.17 }],
  },
  // Polish Zloty (PLN)
  {
    code: "PLN",
    ...
    symbol: "zł",
    rate: 4.2,
    countries: [{ value: "POL", label: "Poland", distanceFactor: 0.8 }],
  },
  // Saudi Riyal (SAR)
  {
    code: "SAR",
    ...
    symbol: "﷼",
    rate: 3.75,
    countries: [{ value: "SAU", label: "Saudi Arabia", distanceFactor: 0.14 }],
  },
  // New Taiwan Dollar (TWD)
  {
    ...
    symbol: "NT$",
    rate: 30,
    countries: [{ value: "TWN", label: "Taiwan", distanceFactor: 0.13 }],
  },
  // Turkish Lira (TRY)
  {
    code: "TRY",
    ...
    symbol: "₺",
    rate: 19,
    countries: [{ value: "TUR", label: "Turkey", distanceFactor: 0.16 }],
  },
  // Additional missing currencies from the select component:
  {
    ...
    symbol: "؋",
    rate: 87.0,
    countries: [{ value: "AFG", label: "Afghanistan", distanceFactor: 0.2 }],
  },
  {
    code: "ALL",
    name: "Albanian Lek",
    symbol: "L",
    rate: 107.0,
    countries: [{ value: "ALB", label: "Albania", distanceFactor: 0.15 }],
  },
  {
    code: "DZD",
    name: "Algerian Dinar",
    symbol: "د.ج",
    rate: 140.0,
    countries: [{ value: "DZA", label: "Algeria", distanceFactor: 0.18 }],
  },
  {
    code: "AOA",
    name: "Angolan Kwanza",
    symbol: "Kz",
    rate: 500.0,
    countries: [{ value: "AGO", label: "Angola", distanceFactor: 0.2 }],
  },
  {
    code: "ARS",
    name: "Argentine Peso",
    symbol: "$",
    rate: 140.0,
    countries: [{ value: "ARG", label: "Argentina", distanceFactor: 0.16 }],
  },
  {
    code: "AMD",
    name: "Armenian Dram",
    symbol: "֏",
    rate: 480.0,
    countries: [{ value: "ARM", label: "Armenia", distanceFactor: 0.17 }],
  },
  {
    code: "AWG",
    name: "Aruban Florin",
    symbol: "ƒ",
    rate: 2.0,
    countries: [{ value: "ABW", label: "Aruba", distanceFactor: 0.14 }],
  },
  {
    code: "AZN",
    ...
    symbol: "₼",
    rate: 1.7,
    countries: [{ value: "AZE", label: "Azerbaijan", distanceFactor: 0.16 }],
  },
  {
    code: "BSD",
    ...
    symbol: "$",
    rate: 1,
    countries: [{ value: "BHS", label: "Bahamas", distanceFactor: 0.3 }],
  },
  {
    code: "BHD",
    name: "Bahraini Dinar",
    symbol: "BHD",
    rate: 0.38,
    countries: [{ value: "BHR", label: "Bahrain", distanceFactor: 0.18 }],
  },
  {
    code: "BDT",
    ...
    symbol: "৳",
    rate: 107.0,
    countries: [{ value: "BGD", label: "Bangladesh", distanceFactor: 0.15 }],
  },
  {
    code: "BBD",
    ...
    symbol: "$",
    rate: 2.0,
    countries: [{ value: "BRB", label: "Barbados", distanceFactor: 0.12 }],
  },
  {
    code: "BYN",
    ...
    symbol: "Br",
    rate: 2.5,
    countries: [{ value: "BLR", label: "Belarus", distanceFactor: 0.1 }],
  },
  {
    code: "BZD",
    name: "Belize Dollar",
    symbol: "$",
    rate: 2.0,
    countries: [{ value: "BLZ", label: "Belize", distanceFactor: 0.8 }],
  },
  {
    code: "BMD",
  ...
  },
  {
    ...
    symbol: "Nu.",
    rate: 74.0,
    countries: [{ value: "BTN", label: "Bhutan", distanceFactor: 0.15 }],
  },
  {
    code: "BOB",
    ...
    symbol: "Bs.",
    rate: 6.9,
    countries: [{ value: "BOL", label: "Bolivia", distanceFactor: 0.14 }],
  },
  {
    code: "BAM",
    ...
    rate: 1.8,
    countries: [
      { value: "BIH", label: "Bosnia and Herzegovina", distanceFactor: 0.1 },
    ],
  },
  {
    code: "BWP",
    ...
    symbol: "P",
    rate: 12.0,
    countries: [{ value: "BWA", label: "Botswana", distanceFactor: 0.15 }],
  },
  {
    code: "BND",
    name: "Brunei Dollar",
    symbol: "$",
    rate: 1.35,
    countries: [{ value: "BRN", label: "Brunei", distanceFactor: 0.18 }],
  },
  {
    code: "BGN",
    name: "Bulgarian Lev",
    symbol: "лв",
    rate: 1.8,
    countries: [{ value: "BGR", label: "Bulgaria", distanceFactor: 0.11 }],
  },
  {
    code: "BIF",
    ...
    symbol: "FBu",
    rate: 2000,
    countries: [{ value: "BDI", label: "Burundi", distanceFactor: 0.2 }],
  },
  {
    code: "XPF",
    name: "CFP Franc",
    ...
    rate: 100,
    countries: [
      { value: "PYF", label: "French Polynesia", distanceFactor: 22 },
    ],
  },
  {
    code: "KHR",
    ...
    symbol: "៛",
    rate: 4100,
    countries: [{ value: "KHM", label: "Cambodia", distanceFactor: 0.17 }],
  },
  {
    code: "CVE",
    ...
    symbol: "Esc",
    rate: 100,
    countries: [{ value: "CPV", label: "Cape Verde", distanceFactor: 22 }],
  },
  {
    code: "KYD",
  ...
  },
  {
    ...
    rate: 600,
    countries: [
      { value: "XAF", label: "Central African region", distanceFactor: 25 },
    ],
  },
  {
    code: "COP",
    ...
    symbol: "$",
    rate: 4000,
    countries: [{ value: "COL", label: "Colombia", distanceFactor: 0.6 }],
  },
  {
    code: "KMF",
    name: "Comorian Franc",
    symbol: "FC",
    rate: 450,
    countries: [{ value: "COM", label: "Comoros", distanceFactor: 28 }],
  },
  {
    code: "CDF",
    ...
    symbol: "FC",
    rate: 2000,
    countries: [{ value: "COD", label: "DR Congo", distanceFactor: 30 }],
  },
  {
    code: "CRC",
    ...
    symbol: "₡",
    rate: 500,
    countries: [{ value: "CRI", label: "Costa Rica", distanceFactor: 0.4 }],
  },
  {
    code: "CUP",
    name: "Cuban Peso",
    symbol: "₱",
    rate: 25,
    countries: [{ value: "CUB", label: "Cuba", distanceFactor: 0.3 }],
  },
  {
    code: "DJF",
    ...
    symbol: "Fdj",
    rate: 177,
    countries: [{ value: "DJI", label: "Djibouti", distanceFactor: 30 }],
  },
  {
    code: "DOP",
    name: "Dominican Peso",
    ...
    rate: 56,
    countries: [
      { value: "DOM", label: "Dominican Republic", distanceFactor: 0.4 },
    ],
  },
  {
    code: "XCD",
    ...
    rate: 2.7,
    countries: [
      { value: "DMA", label: "Eastern Caribbean", distanceFactor: 0.2 },
    ],
  },
  {
    code: "EGP",
    ...
    symbol: "E£",
    rate: 30,
    countries: [{ value: "EGY", label: "Egypt", distanceFactor: 0.9 }],
  },
  {
    code: "ETB",
    name: "Ethiopian Birr",
    symbol: "Br",
    rate: 50,
    countries: [{ value: "ETH", label: "Ethiopia", distanceFactor: 0.1 }],
  },
  {
    code: "FJD",
    name: "Fijian Dollar",
    symbol: "$",
    rate: 2.2,
    countries: [{ value: "FJI", label: "Fiji", distanceFactor: 0.18 }],
  },
  {
    code: "GMD",
    name: "Gambian Dalasi",
    symbol: "D",
    rate: 51,
    countries: [{ value: "GMB", label: "Gambia", distanceFactor: 0.12 }],
  },
  {
    code: "GEL",
    name: "Georgian Lari",
    symbol: "₾",
    rate: 2.8,
    countries: [{ value: "GEO", label: "Georgia", distanceFactor: 0.14 }],
  },
  {
    code: "GHS",
    name: "Ghanaian Cedi",
    symbol: "₵",
    rate: 12,
    countries: [{ value: "GHA", label: "Ghana", distanceFactor: 0.15 }],
  },
  {
    code: "GTQ",
  ...
  },
  {
    ...
    symbol: "FG",
    rate: 9800,
    countries: [{ value: "GIN", label: "Guinea", distanceFactor: 0.2 }],
  },
  {
    code: "GYD",
    ...
    symbol: "$",
    rate: 210,
    countries: [{ value: "GUY", label: "Guyana", distanceFactor: 0.15 }],
  },
  {
    code: "HTG",
    name: "Haitian Gourde",
    symbol: "G",
    rate: 105,
    countries: [{ value: "HTI", label: "Haiti", distanceFactor: 0.4 }],
  },
  {
    code: "HNL",
    ...
    symbol: "L",
    rate: 24,
    countries: [{ value: "HND", label: "Honduras", distanceFactor: 0.4 }],
  },
  {
    code: "ISK",
    ...
    symbol: "kr",
    rate: 140,
    countries: [{ value: "ISL", label: "Iceland", distanceFactor: 0.12 }],
  },
  {
    code: "IRR",
    name: "Iranian Rial",
    symbol: "﷼",
    rate: 42000,
    countries: [{ value: "IRN", label: "Iran", distanceFactor: 0.18 }],
  },
  {
    code: "IQD",
    name: "Iraqi Dinar",
    symbol: "ع.د",
    rate: 1460,
    countries: [{ value: "IRQ", label: "Iraq", distanceFactor: 0.16 }],
  },
  {
    code: "JMD",
    ...
    symbol: "J$",
    rate: 155,
    countries: [{ value: "JAM", label: "Jamaica", distanceFactor: 0.6 }],
  },
  {
    code: "JOD",
    ...
    symbol: "JD",
    rate: 0.71,
    countries: [{ value: "JOR", label: "Jordan", distanceFactor: 0.7 }],
  },
  {
    code: "KZT",
    ...
    symbol: "₸",
    rate: 470,
    countries: [{ value: "KAZ", label: "Kazakhstan", distanceFactor: 0.14 }],
  },
  {
    code: "KES",
    ...
    symbol: "KSh",
    rate: 110,
    countries: [{ value: "KEN", label: "Kenya", distanceFactor: 0.15 }],
  },
  {
    code: "KWD",
    name: "Kuwaiti Dinar",
    symbol: "KD",
    rate: 0.3,
    countries: [{ value: "KWT", label: "Kuwait", distanceFactor: 0.18 }],
  },
  {
    code: "KGS",
    ...
    symbol: "KGS",
    rate: 84,
    countries: [{ value: "KGZ", label: "Kyrgyzstan", distanceFactor: 0.16 }],
  },
  {
    code: "LAK",
    name: "Laotian Kip",
    symbol: "₭",
    rate: 17000,
    countries: [{ value: "LAO", label: "Laos", distanceFactor: 0.18 }],
  },
  {
    code: "LBP",
    name: "Lebanese Pound",
    symbol: "ل.ل",
    rate: 15000,
    countries: [{ value: "LBN", label: "Lebanon", distanceFactor: 0.16 }],
  },
  {
    code: "LSL",
    name: "Lesotho Loti",
    symbol: "L",
    rate: 15,
    countries: [{ value: "LSO", label: "Lesotho", distanceFactor: 0.12 }],
  },
  {
    code: "LRD",
    ...
    symbol: "$",
    rate: 150,
    countries: [{ value: "LBR", label: "Liberia", distanceFactor: 0.12 }],
  },
  {
    code: "LYD",
    name: "Libyan Dinar",
    symbol: "LD",
    rate: 4.5,
    countries: [{ value: "LBY", label: "Libya", distanceFactor: 0.18 }],
  },
  {
    code: "MOP",
    ...
    symbol: "MOP$",
    rate: 8,
    countries: [{ value: "MAC", label: "Macau", distanceFactor: 0.15 }],
  },
  {
    code: "MKD",
    ...
    rate: 55,
    countries: [
      { value: "MKD", label: "North Macedonia", distanceFactor: 0.13 },
    ],
  },
  {
    code: "MGA",
    ...
    symbol: "Ar",
    rate: 4100,
    countries: [{ value: "MDG", label: "Madagascar", distanceFactor: 0.2 }],
  },
  {
    code: "MWK",
    ...
    symbol: "MK",
    rate: 820,
    countries: [{ value: "MWI", label: "Malawi", distanceFactor: 0.18 }],
  },
  {
    code: "MVR",
    ...
    symbol: "Rf",
    rate: 15,
    countries: [{ value: "MDV", label: "Maldives", distanceFactor: 25 }],
  },
  {
    code: "MRU",
    ...
    symbol: "UM",
    rate: 36,
    countries: [{ value: "MRT", label: "Mauritania", distanceFactor: 0.2 }],
  },
  {
    code: "MUR",
    ...
    symbol: "₨",
    rate: 43,
    countries: [{ value: "MUS", label: "Mauritius", distanceFactor: 22 }],
  },
  {
    code: "MDL",
    name: "Moldovan Leu",
    symbol: "L",
    rate: 18,
    countries: [{ value: "MDA", label: "Moldova", distanceFactor: 0.14 }],
  },
  {
    code: "MAD",
    ...
    symbol: "DH",
    rate: 9,
    countries: [{ value: "MAR", label: "Morocco", distanceFactor: 0.12 }],
  },
  {
    code: "MZN",
    ...
    symbol: "Mt",
    rate: 63,
    countries: [{ value: "MOZ", label: "Mozambique", distanceFactor: 22 }],
  },
  {
    code: "MMK",
    name: "Myanmar Kyat",
    symbol: "K",
    rate: 2100,
    countries: [{ value: "MMR", label: "Myanmar", distanceFactor: 0.2 }],
  },
  {
    code: "NAD",
    ...
    symbol: "$",
    rate: 15,
    countries: [{ value: "NAM", label: "Namibia", distanceFactor: 22 }],
  },
  {
    code: "NPR",
    name: "Nepalese Rupee",
    symbol: "रु",
    rate: 130,
    countries: [{ value: "NPL", label: "Nepal", distanceFactor: 0.18 }],
  },
  {
    code: "ANG",
    ...
    rate: 1.79,
    countries: [
      { value: "ANT", label: "Netherlands Antilles", distanceFactor: 0.2 },
    ],
  },
  {
    code: "NIO",
  ...
  },
  {
    ...
    symbol: "₦",
    rate: 460,
    countries: [{ value: "NGA", label: "Nigeria", distanceFactor: 22 }],
  },
  {
    code: "OMR",
    name: "Omani Rial",
    symbol: "OMR",
    rate: 0.38,
    countries: [{ value: "OMN", label: "Oman", distanceFactor: 26 }],
  },
  {
    code: "PAB",
  ...
  },
  {
    ...
    rate: 3.5,
    countries: [
      { value: "PNG", label: "Papua New Guinea", distanceFactor: 28 },
    ],
  },
  {
    code: "PYG",
    ...
    symbol: "₲",
    rate: 8000,
    countries: [{ value: "PRY", label: "Paraguay", distanceFactor: 0.16 }],
  },
  {
    code: "PEN",
    name: "Peruvian Sol",
    symbol: "S/",
    rate: 3.5,
    countries: [{ value: "PER", label: "Peru", distanceFactor: 0.1 }],
  },
  {
    code: "SBD",
    ...
    symbol: "$",
    rate: 7,
    countries: [{ value: "SLB", label: "Solomon Islands", distanceFactor: 32 }],
  },
  {
    code: "SOS",
    ...
    symbol: "Sh",
    rate: 570,
    countries: [{ value: "SOM", label: "Somalia", distanceFactor: 30 }],
  },
  {
    code: "VES",
    ...
    symbol: "Bs.S",
    rate: 20000000,
    countries: [{ value: "VEN", label: "Venezuela", distanceFactor: 0.14 }],
  },
  {
    code: "SDR",
    ...
    symbol: "SDR",
    rate: 1,
    countries: [{ value: "SDR", label: "IMF SDR", distanceFactor: 0 }],
  },
  {
    code: "LKR",
    ...
    symbol: "Rs",
    rate: 370,
    countries: [{ value: "LKA", label: "Sri Lanka", distanceFactor: 0.2 }],
  },
  {
    code: "SDG",
    name: "Sudanese Pound",
    symbol: "LS",
    rate: 600,
    countries: [{ value: "SDN", label: "Sudan", distanceFactor: 24 }],
  },
  {
    code: "SRD",
    ...
    symbol: "$",
    rate: 22,
    countries: [{ value: "SUR", label: "Suriname", distanceFactor: 26 }],
  },
  {
    code: "SZL",
    ...
    symbol: "E",
    rate: 15,
    countries: [{ value: "SWZ", label: "Eswatini", distanceFactor: 24 }],
  },
  {
    code: "TJS",
    ...
    symbol: "SM",
    rate: 11,
    countries: [{ value: "TJK", label: "Tajikistan", distanceFactor: 28 }],
  },
  {
    code: "TZS",
    ...
    symbol: "TSh",
    rate: 2300,
    countries: [{ value: "TZA", label: "Tanzania", distanceFactor: 26 }],
  },
  {
    code: "THB",
    name: "Thai Baht",
    symbol: "฿",
    rate: 33,
    countries: [{ value: "THA", label: "Thailand", distanceFactor: 0.2 }],
  },
  {
    code: "TOP",
    name: "Tongan Paʻanga",
    symbol: "T$",
    rate: 2.3,
    countries: [{ value: "TON", label: "Tonga", distanceFactor: 35 }],
  },
  {
    code: "TTD",
    ...
    rate: 6.8,
    countries: [
      { value: "TTO", label: "Trinidad and Tobago", distanceFactor: 0.12 },
    ],
  },
  {
    code: "TND",
    ...
    symbol: "د.ت",
    rate: 3,
    countries: [{ value: "TUN", label: "Tunisia", distanceFactor: 0.16 }],
  },
  {
    code: "TMT",
    ...
    symbol: "m",
    rate: 3.5,
    countries: [{ value: "TKM", label: "Turkmenistan", distanceFactor: 30 }],
  },
  {
    code: "UGX",
    ...
    symbol: "USh",
    rate: 3700,
    countries: [{ value: "UGA", label: "Uganda", distanceFactor: 35 }],
  },
  {
    code: "UAH",
    ...
    symbol: "₴",
    rate: 27,
    countries: [{ value: "UKR", label: "Ukraine", distanceFactor: 0.2 }],
  },
  {
    code: "UYU",
    name: "Uruguayan Peso",
    symbol: "$",
    rate: 40,
    countries: [{ value: "URY", label: "Uruguay", distanceFactor: 0.1 }],
  },
  {
    code: "UZS",
    ...
    symbol: "so'm",
    rate: 11000,
    countries: [{ value: "UZB", label: "Uzbekistan", distanceFactor: 25 }],
  },
  {
    code: "VND",
    ...
    symbol: "₫",
    rate: 23000,
    countries: [{ value: "VNM", label: "Vietnam", distanceFactor: 22 }],
  },
  {
    code: "XOF",
    ...
    rate: 600,
    countries: [
      { value: "XOF", label: "West African region", distanceFactor: 40 },
    ],
  },
  {
    code: "YER",
    ...
    symbol: "﷼",
    rate: 250,
    countries: [{ value: "YEM", label: "Yemen", distanceFactor: 28 }],
  },
  {
    code: "ZMW",
    name: "Zambian Kwacha",
    symbol: "ZK",
    rate: 20,
    countries: [{ value: "ZMB", label: "Zambia", distanceFactor: 30 }],
  },
];
