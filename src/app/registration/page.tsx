...
export default function RegistrationPage() {
  ...
  return (
    <div className="flex min-h-full relative overflow-hidden justify-center">
      ...
      <Image
        alt=""
        src="https://plus.unsplash.com/premium_photo-1681488262364-8aeb1b6aac56?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZSUyMGNvbW1lcmNlfGVufDB8MHwwfHx8MA%3D%3D"
        width={500}
        height={500}
