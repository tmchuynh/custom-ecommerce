...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await login({ email, identifier: email, password });
  ...
  return (
    <div className="flex min-h-full relative overflow-hidden justify-center">
      <div className="flex z-20 p-9 mb-35 mt-20 bg-muted/60 rounded-2xl">
            ...
            <div className="mt-10">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm/6 font-medium">
                  <span className="bg-white rounded-2xl px-6 text-gray-900">
                    Or continue with
                  </span>
                </div>
              </div>
      ...
      <Image
        ...
        src="https://plus.unsplash.com/premium_photo-1683746792239-6ce8cdd3ac78?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZSUyMGNvbW1lcmNlfGVufDB8fDB8fHww"
        width={900}
        height={900}
